                                        ...
                                        <?php if (!empty($listing['images'])): ?>
                                            <?php foreach ($listing['images'] as $index => $image): ?>
                                                <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
                                                    <img src="<?= htmlspecialchars(asset($image)) ?>"
                                                         class="d-block w-100" alt="Listing Image">
                                                </div>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <div class="carousel-item active">
                                                <img src="/assets/default-image.jpg" class="d-block w-100"
                                    ...
                                    <?php if (!empty($listing['images']) && count($listing['images']) > 1): ?>
                                        <button class="carousel-control-prev" type="button"
                                            ...
                                            <span class="carousel-control-prev-icon" aria-hidden="true"><img
                                                        src="/assets/icons/icons8-back-50.png" alt=""></span>
                                        </button>
                                        <button class="carousel-control-next" type="button"
                                                data-bs-target="#carousel<?= htmlspecialchars($listing['id']) ?>"
                                                data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"><img
                                                        src="/assets/icons/icons8-forward-50.png" alt=""></span>
                                        </button>
                                    <?php endif; ?>
                                </div>
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Hosted
                                        by <?= htmlspecialchars($listing['user_firstname'] . ' ' . $listing['user_lastname']) ?></p>
                                    <p class="card-text">
