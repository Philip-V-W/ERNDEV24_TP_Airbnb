...
class ReservationController extends Controller
{
    ...
    {
        //on instancie Stripe et on lui passe la clé secrète
        ...
        //on déclare un tableau vide pour stocker les payment intents de stripe
        $product_stripe = [];
    ...
    public function successOrder(int $order_id): void
    {
        ...
        $user_id = Session::get(Session::USER)->id;
        //on va reconstruire un tableau de données pour mettre a jour le status de la commande
        $data = [
            'id' => $order_id,
    ...
    /**
     * méthode pour réactiver la commande
     * @param int $id
     * @return void
     */
